...
SECRET_KEY = 'o4v0n&288-*iex16cvs%64!l%6x7!o4py(%&g2(79pa-w_g=$#'
...
CRONJOBS = [
    ...
    ('*/5 * * * *', 'contents.crons.generate_static_index_html',
     '>> /home/python/Desktop/Django_1/meiduo_api/logs/crontab.log')
]
